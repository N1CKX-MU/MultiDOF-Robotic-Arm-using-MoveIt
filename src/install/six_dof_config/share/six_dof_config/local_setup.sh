...
: ${AMENT_CURRENT_PREFIX:="/home/nick/panda_dof_ws/src/install/six_dof_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/six_dof_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/six_dof_config/environment/path.sh"
